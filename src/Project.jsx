...
const Project = () => {
  return (
    <>
      <section
        id="projects"
        className="mb-10 scroll-mt-10 md:mb-24 lg:mb-36 lg:scroll-mt-24"
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      ...
                      href="https://github.com/ismaelmiah/DevTrack/"
                      target="_blank"
                      rel="noreferrer"
                      aria-label="DevTrack"
                    >
                  ...
                  <p className="mt-2 text-sm leading-normal">
                    ...
                    that lets us stay connected and in control.
                  </p>
                </div>
                <img
                  alt=""
                  ...
                  src={"/images/projects/devtrack.png"}
                />
              </div>
            </li>
            <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                      href="https://github.com/ismaelmiah/EduInCare/"
                      target="_blank"
                      rel="noreferrer"
                      aria-label="Edu In Care"
                    >
                      <span className="absolute -inset-x-4 -inset-y-2.5 hidden rounded md:-inset-x-6 md:-inset-y-4 lg:block"></span>
                      <span>
                        Edu-In-Care
                ...
                <img
                  ...
                  className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src={"/images/projects/Edu-In-Care.png"}
                />
              </div>
            </li>
            <li className="mb-12">
              <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
                ...
                <div className="z-10 sm:order-2 sm:col-span-6">
                  <h3>
                    <a
                      className="inline-flex items-baseline font-medium leading-tight text-slate-200 hover:text-teal-300 focus-visible:text-teal-300  group/link text-base"
                      href="https://github.com/ismaelmiah/ReActivity"
                      target="_blank"
                      rel="noreferrer"
                ...
                <img
                  ...
                  className="rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1"
                  style={{ color: "transparent" }}
                  src={"/images/projects/Reactivity.png"}
                />
              </div>
            </li>
          </ul>
